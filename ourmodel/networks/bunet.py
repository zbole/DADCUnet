...
from networks.bunet_system import BRCCAUnetSystem
logger = logging.getLogger(__name__)
class BRCCAUnet(nn.Module):
    def __init__(self, img_size=256, in_chans=3, num_classes=1, n_win=8):
        super(BRCCAUnet, self).__init__()
        self.bra_unet = BRCCAUnetSystem(img_size=img_size,
                                      in_chans=in_chans,
    ...
    def forward(self, x):
        ...
        return logits
    def load_from(self):
        pretrained_path = r'E:\Projects\血管语义分割改进\BRCCA_results/biformer_base_best.pth'
