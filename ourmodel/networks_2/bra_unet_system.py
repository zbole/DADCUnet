...
from networks_2.bra_block import Block
from einops import rearrange
from fairscale.nn.checkpoint import checkpoint_wrapper
from networks_2.bra_decoder_expandx4 import BasicLayer_up
from networks_2.DA_block import DANetHead
...
class BRAUnetSystem(nn.Module):
    def __init__(self, img_size=224,depth=[3, 4, 8, 3],depths_decoder=[2,2,2,2], in_chans=3, num_classes=1000, embed_dim=[64, 128, 320, 512],
        ...
        self.sccsa1 = DANetHead(in_channels=embed_dim[1],out_channels=embed_dim[1])
        self.sccsa2 = DANetHead(in_channels=embed_dim[2],out_channels=embed_dim[2])
        self.sccsa3 = DANetHead(in_channels=embed_dim[3],out_channels=embed_dim[3])
